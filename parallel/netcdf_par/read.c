/* Copyright 2006-2011 University Corporation for Atmospheric
 ...
 #define FILE_NAME "/home/brando.chiminelli/exercises/Project/parallel/netcdf_par/average.nc"
 ...
 int main(int argc, char **argv)
 {
    ...
    /* Open the file. */
    if ((retval = nc_open_par(FILE_NAME_R, NC_NOWRITE | NC_MPIIO, MPI_COMM_WORLD, MPI_INFO_NULL, &ncid_r)))
       ERR(retval);
